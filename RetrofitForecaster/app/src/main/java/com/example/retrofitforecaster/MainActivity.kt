...
interface RetrofitApi {
    @GET("/data/2.5/forecast?lat=54.2021736&lon=30.2964015&appid=355d1d5cfc0be4cf6878caa62163d130")
...
class ListAdapter(private val context: Context, private val list: Array<List>) : RecyclerView.Adapter<ListAdapter.Holder>(){
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.temperature.text = (temp.toBigDecimal().setScale(2, RoundingMode.UP)).toString() + "°C"
    }
}